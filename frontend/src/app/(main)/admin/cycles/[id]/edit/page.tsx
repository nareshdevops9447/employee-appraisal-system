...
import { GoalTemplatesTab } from "@/components/admin/goal-templates-tab";
import { AttributeTemplatesTab } from "@/components/admin/attribute-templates-tab";
    ...
    return (
        <div className="space-y-6 max-w-2xl mx-auto">
            <div>
                ...
                <p className="text-muted-foreground">Manage cycle configuration and mandatory templates.</p>
            </div>

            <Tabs defaultValue="basic" className="space-y-6">
                <TabsList>
                    <TabsTrigger value="basic">Basic Info</TabsTrigger>
                    <TabsTrigger value="goals">Goal Templates</TabsTrigger>
                    <TabsTrigger value="attributes">Attribute Templates</TabsTrigger>
                </TabsList>
                ...
                <TabsContent value="goals">
                    <GoalTemplatesTab cycleId={id} />
                </TabsContent>

                <TabsContent value="attributes">
                    <AttributeTemplatesTab cycleId={id} />
                </TabsContent>
            </Tabs>
        </div>
    );
