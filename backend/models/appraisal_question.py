"""AppraisalQuestion model — questions for appraisal cycles."""
import uuid
...
class AppraisalQuestion(db.Model):
    ...
    cycle_id = db.Column(db.String(36), db.ForeignKey('appraisal_cycles.id', ondelete='CASCADE'), nullable=False, index=True)
    question_text = db.Column(db.Text, nullable=False)
    question_type = db.Column(db.String(30), default='text')
